...
class Backup_QuantizedTCResNet8(nn.Module):
    ...
    def __init__(self, k, n_mels, n_classes):
        ...
        #                                     )
        self.conv_block_d = qnn.QuantConv2d(in_channels=n_mels, out_channels=int(16 * k), kernel_size=(1, 3), stride=1,
        ...
        self.fc0 = qnn.QuantLinear(int(24 * k), n_classes, bias=False, weight_bit_width=qw)
        self.relu_e = qnn.QuantReLU(bit_width=qw, return_quant_tensor=True)
    ...
    def forward_path_train(self, x, exit_point):
        x = self.quant_inp(x)
