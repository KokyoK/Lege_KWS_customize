...
CUDA_VISIBLE_DEVICES=0 nohup python nn_main.py --log logs/oht.csv --feat spec --denoise_loss yes --orth_loss yes --att no --backbone star --denoise_net specu --ptname oht> logs/noisy/oht.py 2>&1 &
...
# CUDA_VISIBLE_DEVICES=0 nohup python nn_main.py --log logs/oh3.csv --feat spec --denoise_loss yes --orth_loss yes --att no --backbone star --denoise_net specu --ptname oh3> logs/noisy/oh3.py 2>&1 &
# CUDA_VISIBLE_DEVICES=0 nohup python nn_main.py --log logs/oh4.csv --feat spec --denoise_loss yes --orth_loss yes --att no --backbone star --denoise_net specu --ptname oh4> logs/noisy/oh4.py 2>&1 &
...
# CUDA_VISIBLE_DEVICES=0 nohup python nn_main.py --log logs/oh6.csv --feat spec --denoise_loss yes --orth_loss yes --att no --backbone star --denoise_net specu --ptname oh6> logs/noisy/oh6.py 2>&1 &