...
# CUDA_VISIBLE_DEVICES=0 nohup python nn_main.py --log logs/my_align_orth.csv --denoise_loss yes --orth_loss yes --att no --backbone star --denoise_net unet --ptname my> logs/noisy/align.py 2>&1 &
